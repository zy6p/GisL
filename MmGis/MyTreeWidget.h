...
private slots:
    ...
    void getAttribute(int layerID, QString attribute);  // �õ����ڷּ���ɫ������
...
signals:
    ...
    void sendColorAndWidthData(int index, QColor fillColor, QColor strokeColor, float width);//������Ⱦ�ź�
    ...
    void setLayerCol(int layerID, QString attri); // �ּ���ɫ

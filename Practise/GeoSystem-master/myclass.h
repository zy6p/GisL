...
signals:
    ...
    void updateMyGLPostgresqlSignal(int mode, int layerID, QString port, QString dbname, QString host, QString user,
    ...
    void sendColorAndWidthData2(int layerID, QColor fillColor, QColor strokeColor, float width);//������Ⱦ�ź�
    void sendColorAndWidthData(vector<QString> names, QColor fillColor, QColor strokeColor, float width);//������Ⱦ�ź�
...
private slots:
    ...
    void getColorAndWidthData(int layerID, QColor fillColor, QColor strokeColor, float width);//������Ⱦ�ź�
    void search();

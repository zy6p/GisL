...
IF (WIN32)
    ...
    IF (MINGW)
        FIND_PATH(GDAL_INCLUDE_DIR gdal.h C:/ProgramData/libFather/include /usr/local/include /usr/include)
        FIND_LIBRARY(GDAL_LIBRARY NAMES gdal_i PATHS C:/ProgramData/libFather/lib /usr/local/lib /usr/lib)
    ENDIF (MINGW)

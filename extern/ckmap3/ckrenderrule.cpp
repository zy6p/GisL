...
CKSymbolizer *CKRenderRule::getPSymbol( ) const {
    return pSymbol;
}

QString CKRenderRule::getField_name( ) const {
    return field_name;
}

QString CKRenderRule::getField_value( ) const {
    return field_value;
}

void CKRenderRule::setPFeature( CKFeature *value ) {
    pFeature = value;
}

void CKRenderRule::draw( ) {
    pFeature->draw( pSymbol );
}
